...
active_listid_query = "SELECT listid FROM fitelist WHERE is_active = 1 ORDER BY listid DESC LIMIT 1"
...
activate_list_query = () ->
    util.format "UPDATE fitelist SET is_active = 1 WHERE listid = (%s)", pending_listid_query
